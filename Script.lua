...
local Window = Library.CreateLib("Felixs Stand GUI                    Star Platinum Over Heaven", "DarkTheme")
...
local StandOwner = Credits:NewSection("Script Owner 👑 felixsowndemise#6225 👑 ")
local GUIOwner = Credits:NewSection("GUI Owner 👑  felixsowndemise#6225 👑 ")
local oh = Credits:NewSection("single pls add")
